...
import {
  ...
  SynchroniseInventoryProductDto,
} from '../types';

export class InventorySyncValidationError extends Error {
...
function validateProduct(
  product: SynchroniseInventoryProductDto,
  index: number,
): void {
...
export function validateSynchroniseInventory(
