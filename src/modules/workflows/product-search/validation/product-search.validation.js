...
exports.ProductSearchValidationError = void 0;
...
// Validation Error
// ==========================================================
class ProductSearchValidationError extends Error {
    constructor(message) {
        super(message);
        this.name = 'ProductSearchValidationError';
    }
}
exports.ProductSearchValidationError = ProductSearchValidationError;
// ==========================================================
// Validation
// ==========================================================
function validateProductSearchQuery(query) {
...
function getOptionalNumber(value, field) {
    if (value === undefined) {
        return undefined;
    }
    if (typeof value !== 'string') {
...
function getOptionalInteger(value, field) {
    if (value === undefined) {
        return undefined;
    }
    if (typeof value !== 'string') {
