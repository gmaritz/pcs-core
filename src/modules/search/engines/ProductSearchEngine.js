...
exports.productSearchEngine = exports.ProductSearchEngine = void 0;
const filters_1 = require("../filters");
// ==========================================================
// Product Search Engine
// ==========================================================
class ProductSearchEngine {
    search(records, criteria) {
        const filteredRecords = filters_1.productFilter.apply(records, criteria);
        const keywordMatched = this.applyKeywordSearch(filteredRecords, criteria.q);
        const sorted = this.sort(keywordMatched, criteria.sort);
    ...
    applyKeywordSearch(records, keyword) {
        if (!keyword?.trim()) {
...
exports.ProductSearchEngine = ProductSearchEngine;
function calculateRelevanceScore(record, terms) {
...
exports.productSearchEngine = new ProductSearchEngine();
