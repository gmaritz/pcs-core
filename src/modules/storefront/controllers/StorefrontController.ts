...
export class StorefrontController {
  ...
  renderCart(req: Request, res: Response): void {
    this.renderPage(req, res, {
  ...
  renderCheckout(req: Request, res: Response): void {
    this.renderPage(req, res, {
  ...
  renderAccount(req: Request, res: Response): void {
    this.renderPage(req, res, {
  ...
  renderOrders(req: Request, res: Response): void {
    this.renderPage(req, res, {
  ...
  renderWishlist(req: Request, res: Response): void {
    this.renderPage(req, res, {
  ...
  renderContact(req: Request, res: Response): void {
    this.renderPage(req, res, {
  ...
  renderAbout(req: Request, res: Response): void {
    this.renderPage(req, res, {
  ...
  renderFaq(req: Request, res: Response): void {
    this.renderPage(req, res, {
      view: 'storefront/faq',
  ...
  renderPrivacy(req: Request, res: Response): void {
    this.renderPage(req, res, {
  ...
  renderTerms(req: Request, res: Response): void {
    this.renderPage(req, res, {
  ...
  renderSports(req: Request, res: Response): void {
    this.renderPage(req, res, {
      view: 'storefront/category',
  ...
  renderBrands(req: Request, res: Response): void {
    this.renderPage(req, res, {
      view: 'storefront/catalog',
  ...
  renderError(req: Request, res: Response): void {
    this.renderPage(req, res, {
